...
// Función para eliminar todas las imágenes que hemos cargado y evitar leaks
//
...
// Esta función gestiona las imágenes del player a medida que se va moviendo
// por el mapa
//
...
// Esta función añade la imagen de los coleccionables 
//
